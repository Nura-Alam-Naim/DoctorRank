...
public class PastAppointment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new AppointmentListAdapter(this, pastAppointments);
        ...
        executor.execute(() -> {
            ...
            ref.get().addOnSuccessListener(snapshot -> {
                ...
                for (DataSnapshot child : snapshot.getChildren()) {
                    ...
                    if (booking != null) {
                        try {
                            ...
                            if (bookingDate != null && bookingDate.before(today)) {
                ...
                handler.post(() -> {
                    ...
                    pastAppointments.addAll(localList);
                    adapter.notifyDataSetChanged();
                });

            }).addOnFailureListener(e ->
                    handler.post(() ->
                            Toast.makeText(PastAppointment.this, "Failed to load data: " + e.getMessage(), Toast.LENGTH_SHORT).show()
                    )
            );
        });
    }
